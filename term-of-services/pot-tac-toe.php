...
<body>
    ...
    <p>These terms and conditions apply to the Pot-Tac-Toe app (hereby referred to as "Application") for mobile devices
        that was created by Potato Developer (hereby referred to as "Service Provider") as a Free service.</p><br>
    ...
    <p>The Application stores and processes personal data that you have provided to the Service Provider in order to
        ...
        features, and may result in the Application not functioning correctly or at all.</p><!----><br>
    ...
    <p>These terms and conditions are effective as of 2025-10-18</p><br><strong>Contact Us</strong>
    <p>If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the
        Service Provider at 93mas.bram@gmailc.om.</p>
    <hr>
